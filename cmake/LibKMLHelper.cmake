...
macro(include_project_vars _project)
  set(${_project}_INCLUDE_DIR "${INSTALL_DIR}/include" )
  string(TOLOWER ${_project} _libname)
  if(WIN32)
    set(_lib ${_libname}${CMAKE_LINK_LIBRARY_SUFFIX})
  else(UNIX)
    if(BUILD_SHARED_LIBS)
      set(_lib lib${_libname}${CMAKE_SHARED_LIBRARY_SUFFIX})
    else()
      set(_lib lib${_libname}.a)
